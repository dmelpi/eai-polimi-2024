/**
 ******************************************************************************
 * File Name          : app_x-cube-vespucci.c
...
int32_t MX_X_CUBE_VESPUCCI_Init(void) {
	...
	PRINT("COMMANDS\r\n"
			...
			"{\"ai_application_mlc*load_ucf\":{\"arguments\":{\"size\":<ucf_file_size_in_bytes>,\"content\":\"<ucf_file_content>\"}}}\r\n"
			"ISPU: \r\n"
			"Start: {\"ai_application_ispu*start\":\"\"}\r\n"
			"Stop: {\"ai_application_ispu*stop\":\"\"}\r\n"
			"{\"ai_application_ispu*load_ucf\":{\"arguments\":{\"size\":<ucf_file_size_in_bytes>,\"content\":\"<ucf_file_content>\"}}}\r\n"
			"SET DFU MODE: \r\n"
